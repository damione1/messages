...
var (
	sessionAllColumns            = []string{"id", "token", "user_id", "ip_address", "user_agent", "expires_at", "created_at", "updated_at"}
	sessionColumnsWithoutDefault = []string{"token", "user_id", "expires_at", "created_at", "updated_at"}
	sessionColumnsWithDefault    = []string{"id", "ip_address", "user_agent"}
